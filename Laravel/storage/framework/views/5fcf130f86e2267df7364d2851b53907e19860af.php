...
<main style="margin-top: 70px">
    ...
    <?php endif; ?>
        <div class="row">
            <div class="col-lg-12">
                <form action="<?php echo e(!empty ($produk) ? route ('produk.update', $produk) : url('produk/create')); ?>" method="POST" enctype="multipart/form-data">
                    <?php if(!empty ($produk)): ?>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                        <input value= "<?php echo e(old('stok')); ?>" type="number" class="form-control" name="stok" id="stok" placeholder="Stok">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                        <input value= "<?php echo e(old('harga_produk')); ?>" type="number" class="form-control" name="harga_produk" id="Harga Produk" placeholder="Stok">
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\10519111\resources\views/produk/form.blade.php ENDPATH**/ ?>